...
export const metadata: Metadata = {
  ...
  description:
    "Politique de confidentialité de JOLANANAS. Découvrez comment nous collectons, utilisons et protégeons vos données personnelles conformément au RGPD.",
  robots: {
    index: true,
    follow: true,
  },
...
export default async function PrivacyPage() {
  ...
  try {
    ...
    console.error(
      "❌ Erreur lors de la lecture du fichier Confidentialité:",
      error,
    );
    throw new Error(
