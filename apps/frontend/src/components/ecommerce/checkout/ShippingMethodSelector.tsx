...
export function ShippingMethodSelector({
  ...
  const standardCost = isFreeShipping
    ? 0
    : shippingInfo?.standardShippingCost || 5.99;
  const expressCost = isFreeShipping
    ? 0
    : shippingInfo?.expressShippingCost || 12.99;
  ...
  return (
    <Card className={className}>
      ...
      <CardContent>
        <RadioGroup
          value={value}
          onValueChange={(val) => onChange(val as ShippingMethodType)}
        >
                ...
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        {shippingInfo?.expressDeliveryDays ||
                          "1-2 jours ouvrés"}
                      </div>
                    </div>
                  </div>
