  ...
  try {
    ...
    try {
      ...
      if (inviteResult.errors && inviteResult.errors.length > 0) {
        console.error('❌ Erreur envoi invitation Shopify:', inviteResult.errors);
      ...
      console.log(`✅ Invitation de réinitialisation envoyée à ${emailLower} (Customer ID: ${customerId})`);
