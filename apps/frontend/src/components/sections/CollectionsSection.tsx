    ...
    const fetchCollections = async () => {
      try {
        ...
        const collectionsData =
          data.collections?.edges?.map((edge: any) => edge.node) || [];
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
            ...
            <span className="text-jolananas-gold">Artisanaux</span>
          </h2>

          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            Chaque collection raconte une histoire unique, façonnée avec passion
            et dévoué à créer des pièces exceptionnelles
          </p>
        </motion.div>
                ...
                <div className="aspect-[4/3] bg-gradient-to-br from-jolananas-peach-light to-jolananas-pink-medium relative overflow-hidden">
                  {collection.image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <span className="text-4xl text-jolananas-pink-deep">
                        📂
                      </span>
                    </div>
                  )}
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed mb-4">
                    {collection.description ||
                      "Collection artisanale exclusive JOLANANAS, créée avec passion et expertise française."}
                  </p>
        ...
        >
          <p className="text-white/80 mb-6">
            Explorez toutes nos créations artisanales
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
