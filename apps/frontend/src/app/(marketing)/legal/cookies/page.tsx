...
export const metadata: Metadata = {
  ...
  description:
    "Politique de cookies de JOLANANAS. Découvrez comment nous utilisons les cookies sur notre site.",
  robots: {
    index: true,
    follow: true,
  },
...
export default async function CookiesPage() {
  const filePath = join(
    process.cwd(),
    "public/assets/documents/Cookies — JOLANANAS.md",
  );
  ...
  try {
    ...
    throw new Error(
      "Impossible de charger la Politique de Cookies. Veuillez réessayer plus tard.",
    );
  }
