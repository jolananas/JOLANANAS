...
export const metadata: Metadata = {
  ...
  description: 'Politique de livraison de JOLANANAS. Découvrez nos modes de livraison, délais et frais.',
  robots: {
    index: true,
    follow: true,
  },
...
export default async function LivraisonPage() {
  ...
  const filePath = join(process.cwd(), 'public/assets/documents/Livraison — JOLANANAS.md');
  ...
  try {
    ...
    throw new Error('Impossible de charger la Politique de Livraison. Veuillez réessayer plus tard.');
  }
