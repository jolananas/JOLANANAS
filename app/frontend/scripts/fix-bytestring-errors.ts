 ...
 *   --path    : Chemin spécifique à scanner (par défaut: app/frontend/app/src)
 */
...
function main() {
  ...
  console.log('🔍 Scan des fichiers pour les caractères Unicode problématiques...\n');
  console.log(`📁 Chemin: ${targetPath}`);
  console.log(`🔧 Mode: ${dryRun ? 'DRY RUN (aucune modification)' : 'Nettoyage actif'}\n`);
