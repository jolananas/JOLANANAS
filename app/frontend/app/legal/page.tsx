...
export const metadata: Metadata = {
  title: 'Mentions Légales - JOLANANAS',
  description: 'Mentions légales du site JOLANANAS. Informations sur l\'éditeur, l\'hébergeur, la propriété intellectuelle et les conditions d\'utilisation.',
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: 'Mentions Légales - JOLANANAS',
    description: 'Mentions légales du site JOLANANAS',
    type: 'website',
  },
};
...
export default async function LegalPage() {
  ...
  const filePath = join(process.cwd(), 'public/assets/documents/Mentions Légales — JOLANANAS.md');
  
  let fileContent: string;
  try {
    fileContent = await readFileWithUnicode(filePath);
  } catch (error) {
    console.error('❌ Erreur lors de la lecture du fichier Mentions Légales:', error);
    throw new Error('Impossible de charger les Mentions Légales. Veuillez réessayer plus tard.');
  }
