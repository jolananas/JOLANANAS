          ...
          <Card className="border-0 shadow-none bg-transparent">
            <CardHeader className="text-center">
              ...
              <Tabs
                value={activeTab}
                onValueChange={(value) =>
                  setActiveTab(value as "products" | "collections")
                }
                className="w-full"
              >
                ...
                {products.length === 0 ? (
                  <Card className="border-0 shadow-none bg-transparent">
                    <CardContent className="text-center py-12">
                      <Badge variant="secondary" className="text-4xl mb-4">
                        🍍
                      </Badge>
          ...
          <Card className="border-0 shadow-none bg-transparent text-center">
            <CardContent>
              ...
              <CardDescription className="text-xs opacity-50 mt-2">
                Cart natif Shopify • Paiement sécurisé • Build with 🩷 by AÏSSA
                BELKOUSSA
              </CardDescription>
            </CardContent>
          </Card>
...
function CollectionCard({ collection }: { collection: Collections }) {
  return (
    <Card className="overflow-hidden hover:shadow-xl transition-shadow">
      <AspectRatio
        ratio={16 / 9}
        className="bg-gradient-to-br from-jolananas-peach-light to-jolananas-pink-medium relative"
      >
        {collection.image ? (
          <img
